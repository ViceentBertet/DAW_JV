...
public class ListaStrings {
    ...
    public static void main(String[] args) {
        ...
        do {
            n = sc.nextInt();
            if (n < 1 || n > 8) {
                System.out.println("No ha introducido una opci♥n de menú válida. Int♥ntelo de nuevo.");
            } else {
                processMenu(n);
            }
        } while (n != 8);
    ...
    public static void createList() {
        ...
        System.out.println("Introducir elementos a la lista, si quieres terminar de introducir elementos, introduce /terminar/: ");
        while (!exit) {
            String add = sc.next().toLowerCase();

            if (FINISH.equalsIgnoreCase(add)) {
                exit = true;
    ...
    public static void processMenu(int opcionMenu) {
        switch (opcionMenu) {
            case 1:
    ...
    public static void modifyInList() {
        ...
        if (n == 1) {
            ...
            System.out.print("Introduce el valor que quieres que permanezca: ");
